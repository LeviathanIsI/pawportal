...
<br />
<div align="center">
  <a href="https://github.com/LeviathanIsI/barkbase">
...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `email_client`, `email`, `project_title`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/LeviathanIsI/barkbase.git
   ```
...
See the [open issues](https://github.com/LeviathanIsI/barkbase/issues) for a full list of proposed features (and known issues).
